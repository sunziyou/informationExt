...
@Slf4j
@Service
public class DeliverGroupMessagesService {
    ...
    public String send(String openConversationId, String text, String sendId) throws Exception {
        ...
        orgGroupSendHeaders.setXAcsDingtalkAccessToken(deliverAccessTokenService.getAccessToken());
    ...
    private void sendprivaterobot(ChatbotMessage chatbotMessage) {
        ...
        batchSendOTOHeaders.xAcsDingtalkAccessToken = deliverAccessTokenService.getAccessToken();
        JSONObject msgParam = new JSONObject();
    ...
    private void sendprivate(ChatbotMessage chatbotMessage) {
        try {
            ...
            String accessToken = deliverAccessTokenService.getAccessToken();
