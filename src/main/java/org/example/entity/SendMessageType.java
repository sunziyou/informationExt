...
public enum SendMessageType {
    ...
    SendMessageType(String code, String description, String dingDingRobotType, String dingDingWorkType, String enterpriseWeChatRobotType, String feiShuRobotType){
       this.code=code;
       this.description=description;
       this.dingDingRobotType=dingDingRobotType;
       this.dingDingWorkType=dingDingWorkType;
       this.enterpriseWeChatRobotType=enterpriseWeChatRobotType;
    ...
    public String getEnterpriseWeChatRobotType() {
        return enterpriseWeChatRobotType;
    }
